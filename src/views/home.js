...
const Home = (props) => {
  return (
    <div className="home-container">
      ...
      <div id="home" className="home-container04">
        <SolutionCard
      ...
      <div id="about" className="home-container08">
        <AboutCard
      ...
      <div className="home-container09">
        ...
        <div className="home-container13">
          <div className="home-container14">
            <svg viewBox="0 0 1060.5714285714284 1024" className="home-icon12">
      ...
      <div id="services" className="home-container19">
      ...
      <div id="contact" className="home-container24">
